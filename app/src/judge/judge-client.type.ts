import type { IJudgeTask } from "./judge.type";
import type { JudgeClientEntity } from "./judge-client.entity";

export interface IJudgeClientSystemInfo {
...
export interface IJudgeClientInfo {
    id: number;
    name: string;
    key: string | null;
    allowedHosts: string[] | null;
    online: boolean;
    systemInfo: IJudgeClientSystemInfo | null;
}

export interface IJudgeClientState {
    judgeClient: JudgeClientEntity;
    pendingTasks: Set<IJudgeTask>;
}
